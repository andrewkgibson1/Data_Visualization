...
bc = read_excel("R:\\Covid\\Long COVID\\Result 0409\\Part B burden by age race gender CMRB\\DID\\Code\\DID_Sequelae_Care.xlsx")
data = data.frame(bc)

data <- subset(data, cohort=="Hospitalized")
...
ggsave("R:\\Covid\\Long COVID\\Result 0409\\Part B burden by age race gender CMRB\\DID\\Sequelae_HOS.pdf", 
